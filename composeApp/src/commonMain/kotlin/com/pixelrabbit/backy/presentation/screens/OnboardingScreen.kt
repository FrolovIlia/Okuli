...
import backy.composeapp.generated.resources.ic_logo_joy
...
fun OnboardingContent() {
    ...
    Column(
        ...
        Text(
            text = "Ваш персональный тренер для здоровья спины и шеи!",
        ...
        Text(
            text = "Регулярные упражнения помогут:\n• Расслабить спину и шею\n• Улучшить осанку\n• Снять усталость после сидения",
