        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Условия использования Oculi",
                    ...
                    Text(
                        text = "Дата последнего обновления: 01.01.2024",
                    ...
                    Column {
                        ...
                        Text(
                            text = """
                                Используя приложение Oculi, вы подтверждаете, что прочитали, 
                    ...
                    Column {
                        ...
                        Text(
                            text = """
                                ...
                                • Oculi является приложением для тренировки зрения и информационных целей
                                • Приложение НЕ заменяет профессиональную медицинскую консультацию
                                • Перед началом любых упражнений проконсультируйтесь с офтальмологом
                                • При появлении боли, дискомфорта или ухудшения зрения немедленно 
                    ...
                    Column {
                        ...
                        Text(
                            text = """
                                Все права на приложение Oculi защищены:
                    ...
                    Text(
                        text = "Благодарим вас за использование Oculi и заботу о здоровье ваших глаз!",
                        style = MaterialTheme.typography.bodyMedium,
